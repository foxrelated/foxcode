...
{	
	...
	{
		(Phpfox::isModule('notification') ? Notification_Service_Process::instance()->add($sType, $iItemId, $iUserId, ($iSentUserId === null ? Phpfox::getUserId() : $iSentUserId)) : null);
	...
	public function delete($sType, $iItemId, $iUserId)
	{
		...
		(Phpfox::isModule('notification') ? Notification_Service_Process::instance()->delete($sType, $iItemId, $iUserId) : null);
