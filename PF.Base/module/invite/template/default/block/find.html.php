...
<form method="post" action="{url link='user.browse'}">
	<input type="text" name="search[keyword]" value="{_p var='search_by_name_or_email'}" onfocus="toggleSearchValue(this, 'focus');" onblur="toggleSearchValue(this, 'blur');" size="25" class="default_value js_is_find_enter" />
	<div class="p_top_8">
		<input type="submit" value="{_p var='search'}" class="button btn-primary" />
	</div>
</form>
