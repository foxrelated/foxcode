...
<li><a href="{url link='photo.edit-album' id=$aForms.album_id}" id="js_edit_this_album">{_p var='edit_this_album'}</a></li>
{/if}
{if Phpfox::getUserId() == $aForms.user_id && $aForms.profile_id == '0'}
<li><a href="{url link='photo.add' album=$aForms.album_id}">{_p var='upload_photos_to_album'}</a></li>
{/if}
...
<li class="item_delete"><a href="{url link='photo.albums' delete=$aForms.album_id}" id="js_delete_this_album" class="sJsConfirm">{_p var='delete'}</a></li>
{/if}
