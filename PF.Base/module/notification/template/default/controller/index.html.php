...
{else}
    ...
    <div id="js_notification_holder">
        ...
        <ul class="table_clear_button" id="js_notification_list_delete">
            <li><input type="button" value="{_p var='delete_all_notifications'}" class="button" onclick="$Core.processForm('#js_notification_list_delete'); $(this).ajaxCall('notification.removeAll'); return false;" /></li>
    ...
    <div id="js_no_notifications"{if count($aNotifications)} style="display:none;"{/if}>
        ...
        <ul class="table_clear_button" id="js_notification_list_delete_clear">
            <li><input type="button" value="{_p var='reset_notification_count'}" class="button button_off" onclick="$Core.processForm('#js_notification_list_delete_clear'); $(this).ajaxCall('notification.removeAll'); return false;" /></li>
            <li class="table_clear_ajax"></li>
        </ul>
        <div class="clear"></div>
    </div>
