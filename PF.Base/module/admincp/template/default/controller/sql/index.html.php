...
<form method="post" action="{url link='admincp.sql'}">
	...
	<div class="table_bottom">
		<input type="submit" name="optimize" value="{_p var='optimize_table_s'}" class="button sJsCheckBoxButton disabled" disabled="true" />
		<input type="submit" name="repair" value="{_p var='repair_table_s'}" class="button sJsCheckBoxButton disabled" disabled="true" />
	</div>
</form>