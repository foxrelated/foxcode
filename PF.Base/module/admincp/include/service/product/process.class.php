...
class Admincp_Service_Product_Process extends Phpfox_Service
{
	...
	public function delete($sProduct)
	{
        ...
        Admincp_Service_Module_Process::instance()->mass('admincp_product_delete', $sProduct);
	...
	public function upgrade($sProductFile)
	{
		...
		if (isset($aParams['modules']['module_id'])) {
			...
			foreach ($aModules as $sModuleUpdate) {
                ...
                Admincp_Service_Module_Process::instance()->install($sModuleUpdate, ['table' => true, 'insert' => true], $aParams['data']['product_id'], $aModuleData);
			}
		}
