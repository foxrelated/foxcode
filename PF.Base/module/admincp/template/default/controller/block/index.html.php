	...
	<div id="content_editor_holder">
		<div id="content_editor_menu">
			<ul>
				...
				<li><a href="#" onclick="$.ajaxCall('admincp.getBlocks', 'm_connection={$sUrl}', 'GET'); $(this).blur(); $('#content_editor_menu a').removeClass('cem_active'); $(this).addClass('cem_active'); return false;">{if empty($sUrl)}{_p var='site_wide'}{else}{$sUrl}{/if}</a></li>
				{/foreach}
			</ul>
			{literal}
			<script>
