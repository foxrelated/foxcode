	...
	<li>
		...
		<div class="block_listing_title">
			...
			<div class="extra_info">
				<ul class="extra_info_middot"><li>{if $aAlbum.total_track == 1}{_p var='1_track'}{else}{$aAlbum.total_track|number_format} {_p var='tracks_lowercase'}{/if}</li><li>&middot;</li><li>{if $aAlbum.total_play == 1}{_p var='1_play'}{else}{$aAlbum.total_play|number_format} {_p var='plays_lowercase'}{/if}</li></ul>
			</div>
		</div>
		<div class="clear"></div>	
	</li>
