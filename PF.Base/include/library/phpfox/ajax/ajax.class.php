...
class Phpfox_Ajax
{
	...
	public function process()
	{
		...
		$this->template()->assign('aGlobalProfilePageLogin', (Phpfox::getUserBy('profile_page_id') ? Pages_Service_Pages::instance()->getLastLogin() : false));
	...
	public function isUser()
	{
		...
		{			
			...
			{				
				...
				echo "tb_show('" . _p('login_title') . "', \$.ajaxBox('user.login', 'height=250&width=400" . ((isset(self::$_aParams[Phpfox::getTokenName()]['is_admincp']) && self::$_aParams[Phpfox::getTokenName()]['is_admincp']) ? '&' . Phpfox::getTokenName() . '[is_admincp]=1' : '') . "'));";
