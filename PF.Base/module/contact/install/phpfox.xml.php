<module>
	...
	<settings>
		...
		<setting group="" module_id="contact" is_hidden="0" type="large_string" var_name="auto_responder_subject" phrase_var_name="setting_auto_responder_subject" ordering="1" version_id="2.0.8"><![CDATA[{_p var='auto_responder_subject'}]]></setting>
		<setting group="" module_id="contact" is_hidden="0" type="large_string" var_name="auto_responder_message" phrase_var_name="setting_auto_responder_message" ordering="1" version_id="2.0.8"><![CDATA[{_p var='auto_responder_message'}]]></setting>
	</settings>
	<hooks>
