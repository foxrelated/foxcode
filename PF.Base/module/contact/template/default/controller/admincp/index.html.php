...
<input type="hidden" name="action" value="add"/>
	<div class="table_header">
		{_p var='add_a_new_category'}
	</div>
	<div class="table form-group">
		<div class="table_left">
			{_p var='module_language'}:
		</div>
...
<form method="post" id="admincp_contact_form_edit" action="{url link='admincp.contact'}">
	...
	<tr>
		<th style="width:10px;">{_p var='order'}</th>
	...
	<div class="table_bottom">
		...
		<input type="submit" name="update" value="{_p var='edit'}" class="button btn-primary" />
	</div>
</form>