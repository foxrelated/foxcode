...
<div class="go_left t_center" style="width:30%;">
	...
	{else}
	<a href="{$aPhoto.link}"{if $aPhoto.mature == 1} onclick="tb_show('{_p var='warning' phpfox_squote=true}', $.ajaxBox('photo.warning', 'height=300&amp;width=350&amp;link={$aPhoto.link}')); return false;"{/if}>{img theme='misc/no_access.png' alt=''}</a>
	{/if}
	<div class="p_4">
