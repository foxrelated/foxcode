...
<li>
	...
	<div class="block_listing_title">
		...
		<div class="extra_info">
			<ul class="extra_info_middot"><li>by {$aSong|user}</li><li>&middot;</li><li>{if $aSong.total_play == 1}{_p var='1_play'}{else}{$aSong.total_play|number_format} {_p var='plays_lowercase'}{/if}</li></ul>
		</div>
	</div>
	<div class="clear"></div>
</li>		