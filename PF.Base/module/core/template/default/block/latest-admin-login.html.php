...
<div class="{if is_int($phpfox.iteration.lastadmins/2)}row1{else}row2{/if}{if $phpfox.iteration.lastadmins == 1} row_first{/if}">
	<div style="position:absolute; right:0; margin-right:8px;">
		<a href="#" title="{_p var='view_attempt'}: {$aLastAdmin.attempt}" onclick="tb_show('{_p var='admincp_login_log' phpfox_squote=true}', $.ajaxBox('core.admincp.viewAdminLogin', 'height=410&amp;width=600&amp;login_id={$aLastAdmin.login_id}')); return false;">
