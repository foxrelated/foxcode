...
{/if}
	...
	<div class="table">
		...
		<div class="table_right">
			<input type="text" name="val[host]" id="host" value="{value type='input' id='host' default='localhost'}" size="30" />
		</div>
	</div>
	<div class="table">
		<div class="table_left">
	...
	<div class="table">
		...
		<div class="table_right">
			<input type="password" name="val[password]" id="password" value="{value type='input' id='password'}" size="30" autocomplete="off" />
		</div>
	</div>
	<div class="table">
		<div class="table_left">
		...
		<div class="table_right">
			<input type="text" name="val[port]" id="port" value="{value type='input' id='port' default='3306'}" size="30" />
		</div>
	</div>
	<div class="table">
		<div class="table_left">
    ...
    <div class="table">
        ...
        <div class="table_right">
            <input type="text" name="val[sitename]" id="sitename" value="{value type='input' id='prefix' default='Site Name'}" size="30" />
        </div>
    </div>
...
{if count($aTables)}
	...
	<input type="submit" value="Drop Tables and Continue with Installation" class="button btn-danger sJsConfirm" />
{else}
